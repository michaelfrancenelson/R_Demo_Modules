...
\begin{frame}{Input commands from external tex file}

knitr can't process newcommands with arguments properly, they must be
defined in an external tex file and then imported.
